...
from app.api.v1.endpoints import auth, exams, adaptive_exams, rag, questions, subtopics
...
router.include_router(subtopics.router, prefix="/subtopics", tags=["subtopics"])
